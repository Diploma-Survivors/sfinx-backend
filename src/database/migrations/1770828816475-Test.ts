...
export class Test1770828816475 implements MigrationInterface {
  name = 'Test1770828816475';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "favorite_lists" DROP CONSTRAINT "FK_97a78758f9bfe7a62f52b18117e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorite_lists" DROP COLUMN "cloned_from_id"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favorite_lists" ADD "cloned_from_id" integer`,
    );
    await queryRunner.query(`DROP TABLE "saved_favorite_lists"`);
    await queryRunner.query(
      `ALTER TABLE "favorite_lists" ADD CONSTRAINT "FK_97a78758f9bfe7a62f52b18117e" FOREIGN KEY ("cloned_from_id") REFERENCES "favorite_lists"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
