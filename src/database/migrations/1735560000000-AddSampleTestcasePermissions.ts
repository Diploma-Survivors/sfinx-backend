...
export class AddSampleTestcasePermissions1735560000000 implements MigrationInterface {
  name = 'AddSampleTestcasePermissions1735560000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Delete permissions for sample_testcase
    // This will cascade delete from role_permissions
    await queryRunner.query(`
        DELETE FROM "permissions" WHERE "resource" = 'sample_testcase'
    `);
  }
}
